...
WebUI.click(findTestObject('Object Repository/Page_Farmacia en lnea con envo gratis a dom_c469f2/div_No'))

//WebUI.click(findTestObject('Object Repository/Page_Farmacia en lnea con envo gratis a dom_c469f2/span_'))
CustomKeywords.'com.customKeywords.myKeywords.clickElement'(findTestObject('Object Repository/Page_Farmacia en lnea con envo gratis a dom_c469f2/span_'))

CustomKeywords.'com.customKeywords.myKeywords.clickElement'(findTestObject('HP/Login_LOGO_HP'))

WebUI.click(findTestObject('Object Repository/Page_Farmacia en lnea con envo gratis a dom_c469f2/button_Inicia sesin'))
...
WebUI.click(findTestObject('Object Repository/Page_Farmacia en lnea con envo gratis a dom_c469f2/i_Correo electrnico_fa fa-eye-slash'))
...
WebUI.click(findTestObject('Object Repository/Page_Farmacia en lnea con envo gratis a dom_c469f2/button_Ingresar'))

CustomKeywords.'com.customKeywords.myKeywords.highlightElement'(findTestObject('Object Repository/Page_Farmacia en lnea con envo gratis a dom_c469f2/a_Categoras'), 
    0)

CustomKeywords.'com.customKeywords.myKeywords.highlightElement'(findTestObject('Object Repository/Page_Farmacia en lnea con envo gratis a dom_c469f2/p_Enviar a Cdigo Postal 14000'), 
    0)

WebUI.click(findTestObject('Object Repository/Page_Farmacia en lnea con envo gratis a dom_c469f2/a_Ofertas'))

CustomKeywords.'com.customKeywords.myKeywords.highlightElement'(findTestObject('Object Repository/Page_Ofertas  San Pablo Farmacia/a_Ofertas'), 0)

CustomKeywords.'com.customKeywords.myKeywords.highlightElement'(findTestObject('Object Repository/Page_Ofertas  San Pablo Farmacia/a_Sucursales'), 0)

CustomKeywords.'com.customKeywords.myKeywords.highlightElement'(findTestObject('Object Repository/Page_Ofertas  San Pablo Farmacia/a_Facturacin'), 0)

CustomKeywords.'com.customKeywords.myKeywords.highlightElement'(findTestObject('Object Repository/Page_Ofertas  San Pablo Farmacia/div_Bienvenido  sudha'), 'Bienvenido sudha')

WebUI.rightClick(findTestObject('Object Repository/Page_Ofertas  San Pablo Farmacia/div_Medicamentos'))

CustomKeywords.'com.customKeywords.myKeywords.highlightElement'(findTestObject('Object Repository/Page_Ofertas  San Pablo Farmacia/img_concat( i class, , fas fa-chevron-right_898612'), 
    0)

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Ofertas  San Pablo Farmacia/div_Ofertas de la semana'), 
    0)

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Ofertas  San Pablo Farmacia/input_Atencin a clientes_searchBoxId'), 
    0)

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Ofertas  San Pablo Farmacia/img'), 0)
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Ofertas  San Pablo Farmacia/div_Medicamentos'), 0)
