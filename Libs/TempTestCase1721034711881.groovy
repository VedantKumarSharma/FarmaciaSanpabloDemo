...
RunConfiguration.setExecutionSettingFile('C:\\Users\\VEDANT~1\\AppData\\Local\\Temp\\Katalon\\Test Cases\\End_to_End\\20240715_144151\\execution.properties')
...
not_run: WebUI.mouseOver(findTestObject('Home Page/Categoras_button_HP'), FailureHandling.STOP_ON_FAILURE)

not_run: WebUI.verifyElementPresent(findTestObject('Object Repository/Home Page/Medicamentos_L1_category_HP'), 0)
...
not_run: WebUI.verifyElementPresent(findTestObject('Object Repository/Home Page/SearchBox_Header_HP'), 0)

not_run: WebUI.verifyElementPresent(findTestObject('Home Page/Logo_hp'), 0)
...
WebUI.verifyElementVisible(findTestObject('Page_Ofertas  San Pablo Farmacia/a_Aerosoles_L3Category'))
