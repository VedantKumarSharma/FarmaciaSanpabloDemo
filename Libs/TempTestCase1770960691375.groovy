...
CustomKeywords.'com.customKeywords.MyKeywords.verifyElementPresentKeyword'(findTestObject('CartPage/productImage_cart'), 
    0)

'verify product name in cart page'
CustomKeywords.'com.customKeywords.MyKeywords.verifyElementPresentKeyword'(findTestObject('CartPage/productName_cart'), 
    0)
